    ...
    <div class="row">
      ...
      <div class="col-10" id="badge-card">
        <div class="carousel-inner row w-100 mx-auto">
          <?php foreach ($badge  as $key => $value) { ?>
            <?php $percent = calBadgeLevel($value->practice_score, $value->objective_score, $value->course_score); ?>
            <div class="carousel-item col-md-4  <?php echo $i == 0 ? 'active' : '' ?> ">

              <div class="card">
                <!-- img -->
                <img class="card-img-top" src="img/badge_img/<?php echo $percent >= 80 ? 'gold' : 'silver' ?>/<?php echo $value->badge_img_name; ?>" alt="Card image cap">

                <div class="card-body">

                  <!-- title -->
                  <div class="card-head-title">
                    <p class="card-title"><?php echo $value->course_name_en; ?></p>
                    <p class="card-sub-title">( <?php echo $value->course_credit; ?> credits )</p>
                  </div>
                  ...
                  <div class="row level-bar">
                    <div class="col-lg-9 col-md-12">
                      <div class="full-bar">
                        <div class="percent-bar <?php echo $percent >= 80 ? 'gold' : 'silver' ?>" style="width: <?php echo $percent . '%' ?>;">
                          <?php echo $percent . '%' ?>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-3 col-md-12  percent-level">
                      <div class="align-center <?php echo $percent >= 80 ? 'gold' : 'silver' ?>">
                        <?php echo $percent >= 80 ? 'Excellent' : ($percent >= 75 ?  'Good' : 'Average') ?>
                      </div>
                    </div>
                  </div>
                  ...
                  <!-- course detail -->
                  <?php
                  $text = $value->course_detail_en; // or $yourtext;
                  $maxPos = 100; // Max. number of characters
