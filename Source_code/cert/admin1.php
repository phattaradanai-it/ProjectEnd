...
<!-- <h2>ชุดวิชา มาจาก รายวิชา อะไรบ้าง</h2>
    <form class="search1" name="search2" method="get" action="">
    <div class="center">
...
<?php
//   รายวิชา ได้ badge อะไร ////
// echo"<h2>รายวิชา ได้ badge อะไร</h2>";
// $sql2 = "SELECT 
...
//         where cert.cert_type_id = 4 
//         AND
//         (course_name_en LIKE '%" . $var_value2 . "%' OR course_name_th LIKE '%" . $var_value2 . "%') limit 10";
//         $query2 = mysqli_query($conn, $sql2)  or die($mysqli->error);
//         $result2 = mysqli_fetch_assoc($query2); 

//         while ($result2 = mysqli_fetch_assoc($query2)) {      
//                 echo $result2["course_name_th"];
//                 echo"<br>";
//                 echo $result2["course_name_en"];
//                 echo"<br>";
//                 echo $result2["badge_img_name"];
//                 echo $result2["cert_type_id"];
//                 echo"<br>";
//                 echo"<br>";
//         }
//  echo"<br><br><br>"; 
